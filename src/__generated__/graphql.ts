...
export type UserFieldsFragment = { __typename?: 'User', id: string, fullName: string, email: string, type: UserType, createdAt: any, updatedAt: any, avatar?: string | null } & { ' $fragmentName'?: 'UserFieldsFragment' };
...
export type EditStatusTaskMutation = { __typename?: 'Mutation', updateTask: { __typename?: 'Task', id: string, status: Status, position: number } };
